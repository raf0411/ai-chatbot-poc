    ...
    try {
      ...
      switch (event.event) {
        case 'thread.run.requires_action':
          console.log('🚨 Requires action from tool');
          await this.channel.sendEvent({
        ...
        case 'thread.message.created':
          console.log('✉️ AI has started responding');
          await this.channel.sendEvent({
            type: 'ai_indicator.update',
        ...
        case 'thread.message.delta':
          console.log('📝 AI is generating text...');
          ...
          if (this.chunk_counter % 15 === 0 || (this.chunk_counter < 8 && this.chunk_counter % 2 === 0)) {
            console.log('📨 Updating chat with partial text:', this.message_text);
        ...
        case 'thread.message.completed':
          console.log('✅ AI response complete:', this.message_text);
          await this.chatClient.partialUpdateMessage(id, {
        ...
        case 'thread.run.step.created':
          ...
          console.log('🚀 AI run started with ID:', this.run_id);
          break;
      }
    } catch (error) {
